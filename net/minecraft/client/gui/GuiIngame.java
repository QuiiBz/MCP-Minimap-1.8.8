...
import fr.quiibz.minimap.Minimap;
...
public class GuiIngame extends Gui
{
    ...
    // QuiiBz start - MinimapRenderer instance
    ...
    public GuiIngame(Minecraft mcIn)
    {
        ...
        // QuiiBz start - Set the MinimapRenderer instance
        this.minimapRenderer = Minimap.getInstance().getRenderer();
        // QuiiBz end
    }
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        // QuiiBz start - Render if F3 is not activated
        if(!this.mc.gameSettings.showDebugInfo && this.minimapRenderer != null)
