...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    // QuiiBz start - The Minimap instance
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        // QuiiBz start - Create the Minimap instance before
        // initializing the GuiIngame, since we fetch it in GuiIngame
    ...
    {
    	// QuiiBz start - Update the Minimap, only if there is a
    	// world currently loaded
    	if(this.theWorld != null) {
    		
    		MinimapRenderer renderer = this.minimap.getRenderer();
        	renderer.runTick();
    	}
    	// QuiiBz end
